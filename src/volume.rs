...
/// Creates a new deployment of `n` pods with the `inanimate/volume-server:latest` docker image inside,
...
pub async fn create(client: Client, name: &str, size: i32, namespace: &str) -> Result<(), Error> {
